...
# from ai_models.OpenSourceLLM import Gemma_2b
...
def giveResponseArray(ai_model, query):
    ...
    if "compose formal email" in task_category:
    ...
    elif "show calendar" in task_category:
...
def handle_message(data):
    ...
    if data[0] == "user-input":
        ai_model = data[1]
        # if ai_model == "Gemma 2B":
        #     response = giveResponseArray(gemma_2b, data[2])
